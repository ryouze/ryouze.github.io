...
Previously, as part of the [PRODIS project](https://prodis-opus19.github.io), I developed the complete ML and data processing infrastructure, including the first [phoneme-level GPT model for Polish](https://arxiv.org/abs/2404.10112).
...
| Dataset preparation                                        | Python, Pandas                 | CLI tool    | Data processing scripts for downloading, cleaning, and phonemizing OpenSubtitles, OSCAR, and Wikipedia corpora into IPA.                                                            |
| Survey cleaner                                             | Python, Pandas                 | CLI tool    | CI-based tool for cleaning and standardizing Microsoft Forms exports with translation and data validation.                                                                          |
| Transcriptions status                                      | Python                         | CLI tool    | CI-based repository scanner that verifies audio transcription structure and generates verification status reports.                                                                  |
| Word frequency                                             | Python, Pandas                 | CLI tool    | Data processing scripts for Polish word frequency statistics and X-SAMPA syllabification with cleaning and alignment.                                                               |
...
| fattura                                                    | C++17, SFML2                   | Desktop app | Simple cross-platform GUI app for editing verification statuses with auto-saving and keyboard navigation.                                                                           |
